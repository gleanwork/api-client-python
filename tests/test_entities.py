...
from glean.api_client.entities import RetrievePersonPhotoAcceptEnum
import os
import pytest
...
def test_entities_listentities():
    ...
    with Glean(
        ...
        res = glean.client.entities.list(
            ...
            page_size=100,
            request_type=models.RequestType.STANDARD,
        )
...
def test_entities_get_person_photo():
    test_http_client = create_test_http_client("getPersonPhoto")
    ...
    with Glean(
        ...
        res = glean.client.entities.retrieve_person_photo(
            person_id="<id>",
            accept_header_override=RetrievePersonPhotoAcceptEnum.IMAGE_PNG,
        )
        assert res is not None
