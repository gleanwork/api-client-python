...
func GeneratedHandlers(ctx context.Context, dir *logging.HTTPFileDirectory, rt *tracking.RequestTracker) []*GeneratedHandler {
	return []*GeneratedHandler{
		...
		NewGeneratedHandler(ctx, http.MethodGet, "/api/skills/{skill_id}", pathGetAPISkillsSkillID(dir, rt)),
		NewGeneratedHandler(ctx, http.MethodGet, "/api/skills/{skill_id}/content", pathGetAPISkillsSkillIDContent(dir, rt)),
		NewGeneratedHandler(ctx, http.MethodGet, "/api/skills/{skill_id}/versions", pathGetAPISkillsSkillIDVersions(dir, rt)),
		NewGeneratedHandler(ctx, http.MethodGet, "/api/skills/{skill_id}/versions/{version}", pathGetAPISkillsSkillIDVersionsVersion(dir, rt)),
		NewGeneratedHandler(ctx, http.MethodGet, "/api/skills/{skill_id}/versions/{version}/content", pathGetAPISkillsSkillIDVersionsVersionContent(dir, rt)),
		NewGeneratedHandler(ctx, http.MethodGet, "/api/trigger-presets", pathGetAPITriggerPresets(dir, rt)),
		NewGeneratedHandler(ctx, http.MethodGet, "/api/trigger-presets/{preset_id}", pathGetAPITriggerPresetsPresetID(dir, rt)),
		...
		NewGeneratedHandler(ctx, http.MethodGet, "/rest/api/v1/tool-servers/{serverId}/tools", pathGetRestAPIV1ToolServersServerIDTools(dir, rt)),
		...
		NewGeneratedHandler(ctx, http.MethodPatch, "/api/triggers/{trigger_id}", pathPatchAPITriggersTriggerID(dir, rt)),
		...
		NewGeneratedHandler(ctx, http.MethodPost, "/api/agents/{agent_id}/cancellations", pathPostAPIAgentsAgentIDCancellations(dir, rt)),
		NewGeneratedHandler(ctx, http.MethodPost, "/api/agents/{agent_id}/responses", pathPostAPIAgentsAgentIDResponses(dir, rt)),
		NewGeneratedHandler(ctx, http.MethodPost, "/api/agents/{agent_id}/runs", pathPostAPIAgentsAgentIDRuns(dir, rt)),
		NewGeneratedHandler(ctx, http.MethodPost, "/api/chat", pathPostAPIChat(dir, rt)),
		...
		NewGeneratedHandler(ctx, http.MethodPost, "/api/index/v1/debug/{datasource}/document", pathPostAPIIndexV1DebugDatasourceDocument(dir, rt)),
		NewGeneratedHandler(ctx, http.MethodPost, "/api/index/v1/debug/{datasource}/document/events", pathPostAPIIndexV1DebugDatasourceDocumentEvents(dir, rt)),
		NewGeneratedHandler(ctx, http.MethodPost, "/api/index/v1/debug/{datasource}/documents", pathPostAPIIndexV1DebugDatasourceDocuments(dir, rt)),
		NewGeneratedHandler(ctx, http.MethodPost, "/api/index/v1/debug/{datasource}/user", pathPostAPIIndexV1DebugDatasourceUser(dir, rt)),
		...
		NewGeneratedHandler(ctx, http.MethodPost, "/api/skills", pathPostAPISkills(dir, rt)),
		NewGeneratedHandler(ctx, http.MethodPost, "/api/skills/import", pathPostAPISkillsImport(dir, rt)),
		NewGeneratedHandler(ctx, http.MethodPost, "/api/skills/sources/preview", pathPostAPISkillsSourcesPreview(dir, rt)),
		NewGeneratedHandler(ctx, http.MethodPost, "/api/skills/validation", pathPostAPISkillsValidation(dir, rt)),
		NewGeneratedHandler(ctx, http.MethodPost, "/api/skills/{skill_id}/sync", pathPostAPISkillsSkillIDSync(dir, rt)),
		NewGeneratedHandler(ctx, http.MethodPost, "/api/skills/{skill_id}/versions", pathPostAPISkillsSkillIDVersions(dir, rt)),
		NewGeneratedHandler(ctx, http.MethodPost, "/api/trigger-presets/{preset_id}/events/search", pathPostAPITriggerPresetsPresetIDEventsSearch(dir, rt)),
		NewGeneratedHandler(ctx, http.MethodPost, "/api/triggers", pathPostAPITriggers(dir, rt)),
		NewGeneratedHandler(ctx, http.MethodPost, "/api/triggers/{trigger_id}/events/search", pathPostAPITriggersTriggerIDEventsSearch(dir, rt)),
		NewGeneratedHandler(ctx, http.MethodPost, "/rest/api/index/submissions/{datasourceInstance}/{type}", pathPostRestAPIIndexSubmissionsDatasourceInstanceType(dir, rt)),
		...
		NewGeneratedHandler(ctx, http.MethodPost, "/rest/api/v1/agents", pathPostRestAPIV1Agents(dir, rt)),
		NewGeneratedHandler(ctx, http.MethodPost, "/rest/api/v1/agents/{agent_id}/import", pathPostRestAPIV1AgentsAgentIDImport(dir, rt)),
		...
		NewGeneratedHandler(ctx, http.MethodPost, "/rest/api/v1/tool-servers/{serverId}/auth", pathPostRestAPIV1ToolServersServerIDAuth(dir, rt)),
		NewGeneratedHandler(ctx, http.MethodPost, "/rest/api/v1/tools/call", pathPostRestAPIV1ToolsCall(dir, rt)),
		...
		NewGeneratedHandler(ctx, http.MethodPut, "/rest/api/index/custom-metadata/schema/{groupName}", pathPutRestAPIIndexCustomMetadataSchemaGroupName(dir, rt)),
		NewGeneratedHandler(ctx, http.MethodPut, "/rest/api/index/document/{docId}/custom-metadata/{groupName}", pathPutRestAPIIndexDocumentDocIDCustomMetadataGroupName(dir, rt)),
	}
}
