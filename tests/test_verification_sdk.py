...
def test_verification_sdk_addverificationreminder():
    ...
    with Glean(
        ...
        assert res == models.Verification(
...
def test_verification_sdk_listverifications():
    ...
    with Glean(
        ...
        assert res is not None
        assert res == models.VerificationFeed(
            documents=[
                models.Verification(
                    state=models.State.VERIFIED,
                    metadata=models.VerificationMetadata(
...
def test_verification_sdk_verify():
