...
with Glean(
    ...
    }, version_source=models.VersionSource.USER)
...
| `messages`                                                                  | List[[models.MessageInput](../../models/messageinput.md)]                   | :heavy_minus_sign:                                                          | The messages to pass an input to the agent.                                 |
