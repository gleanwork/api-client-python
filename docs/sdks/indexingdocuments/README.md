...
* [debug_events](#debug_events) - Beta: Get document lifecycle events
...
with Glean(
    ...
    res = glean.indexing.documents.debug_events(datasource="<value>", object_type="Article", doc_id="art123", start_date="2025-05-01", max_events=50)
