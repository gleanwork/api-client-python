...
class IndexingDatasources(BaseSDK):
    ...
    def submit(
        ...
        *,
        ...
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> models.PostRestAPIIndexSubmissionsDatasourceInstanceTypeResponse:
        r"""Submit datasource data

        Validates and asynchronously processes a datasource-specific submission.

        :param datasource_instance: Datasource instance that should process the submission
        ...
        if server_url is not None:
            ...
            base_url = models.POST_REST_API_INDEX_SUBMISSIONS_DATASOURCE_INSTANCE_TYPE_OP_SERVERS[
                0
            ]
            url_variables = {
        ...
        request = models.PostRestAPIIndexSubmissionsDatasourceInstanceTypeRequest(
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="post_/rest/api/index/submissions/{datasourceInstance}/{type}",
                oauth2_scopes=None,
                security_source=get_security_from_env(
                    self.sdk_configuration.security, models.Security
                ),
        ...
        if utils.match_response(http_res, "500", "application/json"):
            ...
            raise errors.ErrorInfoResponse(response_data, http_res)
        if utils.match_response(http_res, ["405", "413", "4XX"], "*"):
            http_res_text = utils.stream_to_text(http_res)
            raise errors.GleanError("API error occurred", http_res, http_res_text)
