...
class ClientAuthentication(BaseSDK):
    def check_datasource_auth(
        ...
        *,
        ...
        r"""Check datasource authorization
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                operation_id="checkdatasourceauth",
                oauth2_scopes=None,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(models.CheckDatasourceAuthResponse, http_res)
    ...
    async def check_datasource_auth_async(
        self,
        *,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
