...
class PlatformChatFailedResponseObject(str, Enum):
    RESPONSE = "RESPONSE"


class PlatformChatFailedResponseStatus(str, Enum):
    FAILED = "FAILED"


class PlatformChatFailedResponseTypedDict(TypedDict):
    id: str
