...
class ChatRestrictionFiltersTypedDict(TypedDict):
    ...
    document_specs: NotRequired[List[DocumentSpecUnionTypedDict]]
    datasource_instances: NotRequired[List[str]]


class ChatRestrictionFilters(BaseModel):
    ...
    document_specs: Annotated[
        Optional[List[DocumentSpecUnion]], pydantic.Field(alias="documentSpecs")
    ] = None
