...
class CreateAnnouncementRequestChannel(str, Enum):
...
class CreateAnnouncementRequestPostType(str, Enum):
...
class CreateAnnouncementRequestTypedDict(TypedDict):
    start_time: datetime
    ...
    channel: NotRequired[CreateAnnouncementRequestChannel]
    r"""This determines whether this is a Social Feed post or a regular announcement."""
    post_type: NotRequired[CreateAnnouncementRequestPostType]
    r"""This determines whether this is an external-link post or a regular announcement post. TEXT - Regular announcement that can contain rich text. LINK - Announcement that is linked to an external site."""
...
class CreateAnnouncementRequest(BaseModel):
    ...
    channel: Optional[CreateAnnouncementRequestChannel] = None
    r"""This determines whether this is a Social Feed post or a regular announcement."""

    post_type: Annotated[
        Optional[CreateAnnouncementRequestPostType], pydantic.Field(alias="postType")
    ] = None
    r"""This determines whether this is an external-link post or a regular announcement post. TEXT - Regular announcement that can contain rich text. LINK - Announcement that is linked to an external site."""
