...
from glean._hooks import AfterErrorContext, AfterSuccessContext, BeforeRequestContext
from glean.utils import RetryConfig, SerializedRequestBody, get_body_content
import httpx
    ...
    def do_request(
        ...
        def do():
            ...
            if http_res is None:
                ...
                raise errors.GleanError("No response received")
