...
class ClientAuthentication(BaseSDK):
    def create_anonymous_token(
        ...
        *,
        ...
        req = self._build_request(
            method="POST",
            path="/rest/api/v1/createanonymoustoken",
            base_url=base_url,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                operation_id="createanonymoustoken",
                oauth2_scopes=[],
            ...
            request=req,
            error_status_codes=["400", "403", "429", "4XX", "5XX"],
            retry_config=retry_config,
        )

        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, models.CreateAuthTokenResponse)
        if utils.match_response(http_res, ["400", "403", "429", "4XX"], "*"):
    ...
    async def create_anonymous_token_async(
        self,
        *,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
