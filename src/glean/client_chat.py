...
class ClientChat(BaseSDK):
    def ask(
        ...
        *,
        ...
        ask_request: Optional[
            Union[models.AskRequest, models.AskRequestTypedDict]
        ] = None,
        ...
        request = models.AskRequestRequest(
            x_scio_actas=x_scio_actas,
            x_glean_auth_type=x_glean_auth_type,
            ask_request=utils.get_pydantic_model(
                ask_request, Optional[models.AskRequest]
            ),
        )

        req = self._build_request(
            method="POST",
            path="/rest/api/v1/ask",
            base_url=base_url,
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request.ask_request, False, True, "json", Optional[models.AskRequest]
            ),
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, models.AskResponse)
    ...
    def get(
        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, models.GetChatResponse)
        if utils.match_response(http_res, ["400", "401", "403", "429", "4XX"], "*"):
            http_res_text = utils.stream_to_text(http_res)
            raise errors.GleanError(
                "API error occurred", http_res.status_code, http_res_text, http_res
    ...
    def list(
        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, models.ListChatsResponse)
        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(
                http_res.text, models.GetChatApplicationResponse
            )
        if utils.match_response(http_res, ["400", "401", "403", "4XX"], "*"):
            http_res_text = utils.stream_to_text(http_res)
            raise errors.GleanError(
    ...
    def upload_files(
        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, models.UploadChatFilesResponse)
        if utils.match_response(http_res, ["400", "401", "403", "429", "4XX"], "*"):
            http_res_text = utils.stream_to_text(http_res)
            raise errors.GleanError(
                "API error occurred", http_res.status_code, http_res_text, http_res
    ...
    def get_files(
        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, models.GetChatFilesResponse)
        if utils.match_response(http_res, ["400", "401", "403", "429", "4XX"], "*"):
            http_res_text = utils.stream_to_text(http_res)
            raise errors.GleanError(
                "API error occurred", http_res.status_code, http_res_text, http_res
