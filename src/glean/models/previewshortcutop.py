...
class PreviewshortcutRequestTypedDict(TypedDict):
    shortcut_mutable_properties: ShortcutMutablePropertiesTypedDict
...
class PreviewshortcutRequest(BaseModel):
    shortcut_mutable_properties: Annotated[
        ShortcutMutableProperties,
