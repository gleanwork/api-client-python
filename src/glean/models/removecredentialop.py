...
class RemovecredentialRequestRequestTypedDict(TypedDict):
    remove_credential_request: RemoveCredentialRequestTypedDict
...
class RemovecredentialRequestRequest(BaseModel):
    remove_credential_request: Annotated[
        RemoveCredentialRequest,
