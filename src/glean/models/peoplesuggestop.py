...
class PeoplesuggestRequestRequestTypedDict(TypedDict):
    people_suggest_request: PeopleSuggestRequestTypedDict
...
class PeoplesuggestRequestRequest(BaseModel):
    people_suggest_request: Annotated[
