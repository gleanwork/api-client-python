...
class UpdatedraftannouncementRequestRequestTypedDict(TypedDict):
    update_draft_announcement_request: UpdateDraftAnnouncementRequestTypedDict
    r"""Draft announcement content. DraftId needs to be specified."""
...
class UpdatedraftannouncementRequestRequest(BaseModel):
    update_draft_announcement_request: Annotated[
        UpdateDraftAnnouncementRequest,
