...
class CreateDraftAnnouncementRequestChannel(str, Enum):
...
class CreateDraftAnnouncementRequestPostType(str, Enum):
...
class CreateDraftAnnouncementRequestTypedDict(TypedDict):
    ...
    channel: NotRequired[CreateDraftAnnouncementRequestChannel]
    r"""This determines whether this is a Social Feed post or a regular announcement."""
    post_type: NotRequired[CreateDraftAnnouncementRequestPostType]
    r"""This determines whether this is an external-link post or a regular announcement post. TEXT - Regular announcement that can contain rich text. LINK - Announcement that is linked to an external site."""
    ...
    id: NotRequired[int]
    r"""The opaque id of the parent announcement."""


class CreateDraftAnnouncementRequest(BaseModel):
    ...
    channel: Optional[CreateDraftAnnouncementRequestChannel] = None
    r"""This determines whether this is a Social Feed post or a regular announcement."""

    post_type: Annotated[
        Optional[CreateDraftAnnouncementRequestPostType],
        pydantic.Field(alias="postType"),
    ] = None
    r"""This determines whether this is an external-link post or a regular announcement post. TEXT - Regular announcement that can contain rich text. LINK - Announcement that is linked to an external site."""
