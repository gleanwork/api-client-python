...
class DeletequeryhistoryRequestRequestTypedDict(TypedDict):
    delete_query_history_request: DeleteQueryHistoryRequestTypedDict
    r"""Delete query history request"""
...
class DeletequeryhistoryRequestRequest(BaseModel):
    delete_query_history_request: Annotated[
        DeleteQueryHistoryRequest,
