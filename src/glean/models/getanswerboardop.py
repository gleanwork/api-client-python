...
class GetanswerboardRequestRequestTypedDict(TypedDict):
    get_answer_board_request: GetAnswerBoardRequestTypedDict
    r"""GetAnswerBoard request"""
...
class GetanswerboardRequestRequest(BaseModel):
    get_answer_board_request: Annotated[
