...
class DeletedisplayablelistsRequestRequestTypedDict(TypedDict):
    delete_displayable_lists_request: DeleteDisplayableListsRequestTypedDict
...
class DeletedisplayablelistsRequestRequest(BaseModel):
    delete_displayable_lists_request: Annotated[
        DeleteDisplayableListsRequest,
