...
class AnnouncementMutablePropertiesChannel(str, Enum):
...
class AnnouncementMutablePropertiesPostType(str, Enum):
...
class AnnouncementMutablePropertiesTypedDict(TypedDict):
    ...
    channel: NotRequired[AnnouncementMutablePropertiesChannel]
    r"""This determines whether this is a Social Feed post or a regular announcement."""
    post_type: NotRequired[AnnouncementMutablePropertiesPostType]
    r"""This determines whether this is an external-link post or a regular announcement post. TEXT - Regular announcement that can contain rich text. LINK - Announcement that is linked to an external site."""
...
class AnnouncementMutableProperties(BaseModel):
    ...
    channel: Optional[AnnouncementMutablePropertiesChannel] = None
    r"""This determines whether this is a Social Feed post or a regular announcement."""

    post_type: Annotated[
        Optional[AnnouncementMutablePropertiesPostType],
