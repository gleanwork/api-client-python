...
class UpdateanswerlikesRequestRequestTypedDict(TypedDict):
    update_answer_likes_request: UpdateAnswerLikesRequestTypedDict
    r"""UpdateAnswerLikes request"""
...
class UpdateanswerlikesRequestRequest(BaseModel):
    update_answer_likes_request: Annotated[
        UpdateAnswerLikesRequest,
