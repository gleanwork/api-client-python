...
class UnpublishannouncementRequestRequestTypedDict(TypedDict):
    unpublish_announcement_request: UnpublishAnnouncementRequestTypedDict
    r"""Unpublish announcement content."""
...
class UnpublishannouncementRequestRequest(BaseModel):
    unpublish_announcement_request: Annotated[
        UnpublishAnnouncementRequest,
