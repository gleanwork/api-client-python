...
class DeleteanswerboardsRequestRequestTypedDict(TypedDict):
    delete_answer_boards_request: DeleteAnswerBoardsRequestTypedDict
    r"""DeleteAnswerBoards request"""
...
class DeleteanswerboardsRequestRequest(BaseModel):
    delete_answer_boards_request: Annotated[
        DeleteAnswerBoardsRequest,
