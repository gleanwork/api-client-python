...
class CreateCollectionResponseErrorCode(str, Enum):
...
class CreateCollectionResponseTypedDict(TypedDict):
    ...
    error_code: CreateCollectionResponseErrorCode
...
class CreateCollectionResponse(BaseModel):
    ...
    error_code: Annotated[
        CreateCollectionResponseErrorCode, pydantic.Field(alias="errorCode")
    ]
