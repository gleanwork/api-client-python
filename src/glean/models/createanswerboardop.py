...
class CreateanswerboardRequestTypedDict(TypedDict):
    collection_base_mutable_properties: CollectionBaseMutablePropertiesTypedDict
    r"""Answer Board content plus any additional metadata for the request."""
...
class CreateanswerboardRequest(BaseModel):
    collection_base_mutable_properties: Annotated[
        CollectionBaseMutableProperties,
