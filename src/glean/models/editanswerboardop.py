...
class EditanswerboardRequestRequestTypedDict(TypedDict):
    edit_answer_board_request: EditAnswerBoardRequestTypedDict
...
class EditanswerboardRequestRequest(BaseModel):
    edit_answer_board_request: Annotated[
        EditAnswerBoardRequest,
