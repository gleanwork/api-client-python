...
class CreatedisplayablelistsRequestRequestTypedDict(TypedDict):
    create_displayable_lists_request: CreateDisplayableListsRequestTypedDict
    r"""Create new displayable lists"""
...
class CreatedisplayablelistsRequestRequest(BaseModel):
    create_displayable_lists_request: Annotated[
        CreateDisplayableListsRequest,
