...
class GetagentinputsRequestRequestTypedDict(TypedDict):
    get_agent_inputs_request: GetAgentInputsRequestTypedDict
...
class GetagentinputsRequestRequest(BaseModel):
    get_agent_inputs_request: Annotated[
