...
from .teamsrequest import TeamsRequest, TeamsRequestTypedDict
...
class TeamsRequestRequestTypedDict(TypedDict):
    teams_request: TeamsRequestTypedDict
    r"""Teams request"""
...
class TeamsRequestRequest(BaseModel):
    teams_request: Annotated[
        TeamsRequest,
