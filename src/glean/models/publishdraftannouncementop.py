...
class PublishdraftannouncementRequestRequestTypedDict(TypedDict):
    publish_draft_announcement_request: PublishDraftAnnouncementRequestTypedDict
    r"""Publish draft announcement content."""
...
class PublishdraftannouncementRequestRequest(BaseModel):
    publish_draft_announcement_request: Annotated[
        PublishDraftAnnouncementRequest,
