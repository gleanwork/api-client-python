...
class EditdocumentcollectionsRequestRequestTypedDict(TypedDict):
    edit_document_collections_request: EditDocumentCollectionsRequestTypedDict
    r"""Data describing the edit operation."""
...
class EditdocumentcollectionsRequestRequest(BaseModel):
    edit_document_collections_request: Annotated[
        EditDocumentCollectionsRequest,
