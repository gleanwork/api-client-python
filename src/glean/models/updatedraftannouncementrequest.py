...
class UpdateDraftAnnouncementRequestChannel(str, Enum):
...
class UpdateDraftAnnouncementRequestPostType(str, Enum):
...
class UpdateDraftAnnouncementRequestTypedDict(TypedDict):
    draft_id: int
    r"""The opaque id of the draft."""
    ...
    channel: NotRequired[UpdateDraftAnnouncementRequestChannel]
    r"""This determines whether this is a Social Feed post or a regular announcement."""
    post_type: NotRequired[UpdateDraftAnnouncementRequestPostType]
    r"""This determines whether this is an external-link post or a regular announcement post. TEXT - Regular announcement that can contain rich text. LINK - Announcement that is linked to an external site."""
...
class UpdateDraftAnnouncementRequest(BaseModel):
    draft_id: Annotated[int, pydantic.Field(alias="draftId")]
    r"""The opaque id of the draft."""
    ...
    channel: Optional[UpdateDraftAnnouncementRequestChannel] = None
    r"""This determines whether this is a Social Feed post or a regular announcement."""

    post_type: Annotated[
        Optional[UpdateDraftAnnouncementRequestPostType],
