...
class GeteventsRequestRequestTypedDict(TypedDict):
    get_events_request: GetEventsRequestTypedDict
    r"""GetEvents request"""
...
class GeteventsRequestRequest(BaseModel):
    get_events_request: Annotated[
        GetEventsRequest,
