...
class PreviewannouncementdraftRequestTypedDict(TypedDict):
    preview_ugc_request: PreviewUgcRequestTypedDict
    r"""preview announcement request"""
...
class PreviewannouncementdraftRequest(BaseModel):
    preview_ugc_request: Annotated[
        PreviewUgcRequest,
