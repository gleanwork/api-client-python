...
from .askrequest import AskRequest, AskRequestTypedDict
...
class AskRequestRequestTypedDict(TypedDict):
    ...
    ask_request: NotRequired[AskRequestTypedDict]
    r"""Ask request"""


class AskRequestRequest(BaseModel):
