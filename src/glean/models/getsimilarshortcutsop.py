...
class GetsimilarshortcutsRequestRequestTypedDict(TypedDict):
    get_similar_shortcuts_request: GetSimilarShortcutsRequestTypedDict
    r"""GetSimilarShortcuts request"""
...
class GetsimilarshortcutsRequestRequest(BaseModel):
    get_similar_shortcuts_request: Annotated[
        GetSimilarShortcutsRequest,
