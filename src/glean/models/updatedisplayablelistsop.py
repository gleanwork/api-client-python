...
class UpdatedisplayablelistsRequestRequestTypedDict(TypedDict):
    update_displayable_lists_request: UpdateDisplayableListsRequestTypedDict
    r"""Updated version of the displayable list configs."""
...
class UpdatedisplayablelistsRequestRequest(BaseModel):
    update_displayable_lists_request: Annotated[
        UpdateDisplayableListsRequest,
